...
def add_all(world):
    ...
    # 「登记」需玩家先【杀过一只敌怪】（requires_kill）——光武装不算数，得亲手放倒过东西、
    # 证明能在回廊活命，才够格在册。破局闭环：弄到家伙 → 出城杀一只 → 回来盖章。
    world.add_object(GameObject(
        id="registry_officer",
        name="回廊登记官·独臂奥兰",
        description=(
            ...
            "「登记？可以。规矩就一条——没在回廊里见过血的，不收。」"
            "他用仅剩的那只手敲了敲名册，「光拎把家伙不算数，谁都会拿棍子。"
            "亲手放倒过一只东西、证明你能自己活命的，再来——烙印随你领，军备架、迷宫，都给你开。」"
        ),
        kind="npc",
        ...
        affordances={
            "register": Affordance(
                verb="register",
                desc="登记造册、烙上回廊烙印，成为在册攻略者（须已击杀过任意敌怪）",
                requires_kill=True,   # 引擎硬门：必须已放倒过至少一只敌怪（has_slain_enemy）
                effect={
                    "flags": {"attacker_registered": True},
                    "clues": [
                        "奥兰抬眼把你从头到脚扫了一遍，像在嗅什么，「……见过血了。凑合。」"
                        "他翻开名册，烙印铁按上你左腕——一阵灼痛，皮下浮起一道淡蓝的回廊纹。"
                        "「在册了。军备架随你领，迷宫的门也认你了。活着回来，新人。」"
                        "——你头一回，在这座塔里有了名字。",
                    ],
                },
            ),
